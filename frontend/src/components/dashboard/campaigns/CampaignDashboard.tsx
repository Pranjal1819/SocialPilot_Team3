...
export default function CampaignDashboard() {
  ...
  // When rendered inside a Marketing Team client workspace
  // (/marketing-team/clients/[businessOwnerId]/campaigns), extract the
  // businessOwnerId from the path so the backend scopes campaigns to that
  // client. Outside a client workspace this is undefined and the backend
  // falls back to the current user's own campaigns.
